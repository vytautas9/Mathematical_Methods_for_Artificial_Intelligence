...
Top 25 variables by importance according to the accuracy:
```{r}
varImpPlot(rf_final, n.var = 25, type = 1)
```

We can see, that there are no exceptional features which contributes the most to the accuracy as the difference between SORTED variables by mean decrease in accuracy are not that high.
