...
Conditional Inference Tree gave us the best result, the overall accuracy reaches 99.15%, while the accuracies for each class are: F_Q_SVEB = 78.4%, N = 99.7% and VEB = 97.4%.
